...
# BOARD EVAL -----------------------------------------------------------------
    ...
    # Evaluting a board score from 1000 to -1000 based on threts of each side to win. 
    # I would recommend adding more factors like controling the middle, blocking opponents attempts to win and more
...
# BOARD EVAL -----------------------------------------------------------------
    ...
    def select_best_move(self):
        best_move, best_value = self.minimax(4, -float('inf'), float('inf'), True)
        return best_move[0] # best_move is a the list of the best moves of each player (sequance of moves), we take only the first move in seq
...
if __name__ == "__main__":
    ...
    generate_dataset(100, dataset_filename)  # For smaller dataset
    # generate_dataset(50000, dataset_filename)  # For larger dataset
